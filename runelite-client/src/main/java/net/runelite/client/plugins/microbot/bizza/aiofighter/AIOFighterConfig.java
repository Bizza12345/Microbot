...
import net.runelite.client.plugins.microbot.bizza.aiofighter.enums.DefaultLooterStyle;
import net.runelite.client.plugins.microbot.bizza.aiofighter.enums.AttackStyleOption;
import net.runelite.client.plugins.microbot.bizza.aiofighter.enums.PlayStyle;
...
//    }
    ...
    @ConfigItem(
            keyName = "fixedAttackStyle",
            name = "Fixed Attack Style",
            description = "Always use this attack style when training",
            position = 12,
            section = skillingSection
    )
    default AttackStyleOption fixedAttackStyle() {
        return AttackStyleOption.DEFAULT;
    }
