...
import static net.runelite.client.plugins.microbot.bizza.aiofighter.combat.AttackNpcScript.filteredAttackableNpcs;
import static net.runelite.client.plugins.microbot.bizza.aiofighter.combat.FlickerScript.currentMonstersAttackingUs;
