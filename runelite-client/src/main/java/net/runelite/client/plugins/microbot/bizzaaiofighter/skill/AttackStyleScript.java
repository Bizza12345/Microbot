package net.runelite.client.plugins.microbot.bizzaaiofighter.skill;
...
public class AttackStyleScript extends Script {
    ...
    private HardAttackStyle hardAttackStyle = HardAttackStyle.NONE;
    ...
    private void scheduledTask(BizzaAIOFighterConfig config) {
        try {
    ...
    private void changeAttackStyle(BizzaAIOFighterConfig config, WidgetInfo attackStyleWidgetInfo) {
    ...
    private WidgetInfo getWidgetForStyle(AttackStyle style) {
        ...
        for (int i = 0; i < attackStyles.length; i++) {
            if (attackStyles[i] == style) {
                switch (i) {
                    case 0: return WidgetInfo.COMBAT_STYLE_ONE;
                    case 1: return WidgetInfo.COMBAT_STYLE_TWO;
                    case 2: return WidgetInfo.COMBAT_STYLE_THREE;
                    case 3: return WidgetInfo.COMBAT_STYLE_FOUR;
                    case 4: return WidgetInfo.COMBAT_SPELLS;
                    case 5: return WidgetInfo.COMBAT_DEFENSIVE_SPELL_BOX;
                }
            }
        }
        return null;
    ...
    private void selectSkills(BizzaAIOFighterConfig config) {
    ...
    private WidgetInfo getComponentToDisplay(BizzaAIOFighterConfig config) {
