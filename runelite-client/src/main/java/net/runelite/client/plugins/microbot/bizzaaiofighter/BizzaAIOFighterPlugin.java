...
import net.runelite.client.plugins.microbot.bizzaaiofighter.bank.BankerScript;
import net.runelite.client.plugins.microbot.bizzaaiofighter.cannon.CannonScript;
import net.runelite.client.plugins.microbot.bizzaaiofighter.combat.*;
...
import net.runelite.client.plugins.microbot.bizzaaiofighter.loot.LootScript;
import net.runelite.client.plugins.microbot.bizzaaiofighter.safety.SafetyScript;
import net.runelite.client.plugins.microbot.bizzaaiofighter.skill.AttackStyleScript;
...
@Slf4j
public class BizzaAIOFighterPlugin extends Plugin {
    ...
    @Inject
    private BizzaAIOFighterConfig config;
    @Inject
    private ConfigManager configManager;
    @Inject
    private OverlayManager overlayManager;
    @Inject
    private BizzaAIOFighterOverlay playerAssistOverlay;
    @Inject
    private BizzaAIOFighterInfoOverlay playerAssistInfoOverlay;
    ...
    @Provides
    BizzaAIOFighterConfig provideConfig(ConfigManager configManager) {
        return configManager.getConfig(BizzaAIOFighterConfig.class);
    }
