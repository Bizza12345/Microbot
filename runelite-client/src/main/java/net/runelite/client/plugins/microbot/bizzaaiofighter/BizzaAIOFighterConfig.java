...
import net.runelite.client.plugins.microbot.bizzaaiofighter.enums.PlayStyle;
...
@ConfigGroup(BizzaAIOFighterConfig.GROUP)
...
public interface BizzaAIOFighterConfig extends Config {
...
//    }
    ...
    @ConfigItem(
            keyName = "hardAttackStyle",
            name = "Hardcoded Attack Style",
            description = "Always use this attack style if set",
            position = 12,
            section = skillingSection
    )
    default HardAttackStyle hardAttackStyle() {
        return HardAttackStyle.NONE;
    }
