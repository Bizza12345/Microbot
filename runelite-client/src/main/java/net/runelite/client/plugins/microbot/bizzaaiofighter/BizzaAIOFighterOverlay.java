...
import net.runelite.client.plugins.microbot.bizzaaiofighter.model.Monster;
...
import static net.runelite.client.plugins.microbot.bizzaaiofighter.combat.AttackNpcScript.filteredAttackableNpcs;
import static net.runelite.client.plugins.microbot.bizzaaiofighter.combat.FlickerScript.currentMonstersAttackingUs;
import static net.runelite.client.ui.overlay.OverlayUtil.renderPolygon;

public class BizzaAIOFighterOverlay extends OverlayPanel {
    ...
    @Inject
    private BizzaAIOFighterOverlay(ModelOutlineRenderer modelOutlineRenderer, BizzaAIOFighterConfig config) {
