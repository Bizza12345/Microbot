package net.runelite.client.plugins.microbot.bizza.aiofighter;
...
import net.runelite.client.plugins.microbot.bizza.aiofighter.bank.BankerScript;
import net.runelite.client.plugins.microbot.bizza.aiofighter.cannon.CannonScript;
import net.runelite.client.plugins.microbot.bizza.aiofighter.combat.*;
import net.runelite.client.plugins.microbot.bizza.aiofighter.enums.PrayerStyle;
import net.runelite.client.plugins.microbot.bizza.aiofighter.enums.State;
import net.runelite.client.plugins.microbot.bizza.aiofighter.loot.LootScript;
import net.runelite.client.plugins.microbot.bizza.aiofighter.safety.SafetyScript;
import net.runelite.client.plugins.microbot.bizza.aiofighter.skill.AttackStyleScript;
